...
import thumbnail from "../../assets/project_images/giant_eagle_accessibility_design/thumbnail.svg";
...
const GiantEagleAccessibilityDesignCard: React.FC<{}> = () => {
    ...
    return (
        <Card title={title} imageRef={thumbnail} link={link} description={description} imagePadding={"10px"}>
