        ...
        <div className="Home">
            ...
            <div className='Body'>
                ...
                <div className='Section' style={{marginTop: "100px", marginBottom: "100px"}}>
                    <h1>Melissa Gibney is a UX engineer studying at Carnegie Mellon University. She is enthralled by audio software and AI and has a passion for creating <em>clean</em>, <em>playful</em> applications.</h1>
                </div>
